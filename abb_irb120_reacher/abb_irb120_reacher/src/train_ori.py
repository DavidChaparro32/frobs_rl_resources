...
from abb_irb120_reacher.task_env import irb120_reacher
import gym
import rospy
import rospkg
import sys
...
if __name__ == '__main__':
    ...
    #-- TD3
    save_path = pkg_path + "/models/full_reacher/td3_2/"
    log_path = pkg_path + "/logs/full_reacher/td3_2/"
    model = TD3(env, save_path, log_path, config_file_pkg="abb_irb120_reacher", config_filename="td3_ori.yaml")
